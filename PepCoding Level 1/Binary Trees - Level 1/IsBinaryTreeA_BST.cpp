...
// Gfg Link: https://www.geeksforgeeks.org/a-program-to-check-if-a-binary-tree-is-bst-or-not/
#include <bits/stdc++.h>
using namespace std;
...
// Analysis: https://nados.io/article/is-a-binary-search-tree#:~:text=for%20this%20code.-,Analysis,-%3A
