// Article Link: https://nados.io/content/traversal-in-a-binary-tree
// Video playlist: https://youtu.be/BuVNOAh33No?list=PLNQqARTgXkMbp1R47hg9NnCNVAraXJv99
#include <bits/stdc++.h>
using namespace std;
...
void allTraversals(TreeNode* root) {
    if (not root) return;
    cout << "Preorder " << root->val << "\n";
    allTraversals(root->left);
    cout << "Inorder " << root->val << "\n";
    allTraversals(root->right);
...
int main() {
    ...
    cout << "Recursive preorder traversal in binary tree: ";
    preorder(root);
    cout << "\n\n";

    cout << "Recursive inorder traversal in binary tree: ";
    inorder(root);
    cout << "\n\n";

    cout << "Recursive postorder traversal in binary tree: ";
    postorder(root);
    cout << "\n\n";

    cout << "All recursive traversals at once: \n";
    allTraversals(root);
    cout << "\n";
