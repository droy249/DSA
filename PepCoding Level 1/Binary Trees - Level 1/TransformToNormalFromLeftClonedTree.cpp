// Question Link: https://nados.io/question/transform-to-normal-from-left-cloned-tree
// Video Link: https://youtu.be/AvXVChZoZkU?list=PLNQqARTgXkMbp1R47hg9NnCNVAraXJv99
#include <bits/stdc++.h>
using namespace std;
...
TreeNode* transformBackPepCoding(TreeNode*& root) {
    if (not root) return nullptr;
    root->left = transformBackPepCoding(root->left->left), root->right = transformBackPepCoding(root->right);
    return root;
}
