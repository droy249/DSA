// Question Link: https://nados.io/question/tilt-of-binary-tree
// Video Link: https://youtu.be/gK95sG7Dm-w?list=PLNQqARTgXkMbp1R47hg9NnCNVAraXJv99
...
// Approach 1 (Using travel and update)
int tiltOfBinaryTree1(struct TreeNode* root, int& tilt) {
    if(!root) return 0;
    
    int leftSum = tiltOfBinaryTree1(root->left, tilt);
    int rightSum = tiltOfBinaryTree1(root->right, tilt);
...
int main() {
    ...
    int tilt{};
    tiltOfBinaryTree1(root, tilt);
    cout << "Tilt of given binary tree: " << tilt << "\n";
